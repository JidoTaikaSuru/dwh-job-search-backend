...
//
// /*
// The below will issue a VC that says that we, the issuer, have interviewed the user
//
// TODO This one (for now) requires no validation because we didn't have time to implement manual review of media submissions
//  */
