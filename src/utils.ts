...
const mesh_node_registry_tbl = await sql`
create table  IF NOT EXISTS
  public.mesh_node_registry (
...
`
const fed_data_able = await sql` create table IF NOT EXISTS
  public.fed_data (
    cid text not null,
    data json not null,
...
const fed_data_binary_table = await sql` create table IF NOT EXISTS
  public.fed_data_binary (
    cid text not null,
    data bytea not null,
    author_did text not null,
    publisher_did text not null,
